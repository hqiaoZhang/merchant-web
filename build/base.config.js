...
//项目编译输出目录
const projectName = 'merchant-web'
...
module.exports = {
  ...
  dev: {
    ...
    proxyTable: {
      '/manager': {
        // target: 'https://wcenter.waming-air.com',// 正式环境
        target: 'http://58.83.189.156:9900', // 开发环境
        // target: 'http://test.aitectcare.com:9001', // 测试环境
        // target: 'http://192.168.3.127:48080', // 联调环境
      ...
      '/qualitis': {
        target: 'http://58.83.189.156:9900', // 开发环境
        // target: 'http://test.aitectcare.com:9001', // 测试环境
        // target: 'http://192.168.0.119:20001', // 联调环境
        changeOrigin: true, //如果接口跨域，需要进行这个参数配置
        secure: false,  // 如果是https接口，需要配置这个参数
      }
    },
